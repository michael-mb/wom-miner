...
def getWordsBefore(start, html, word, number):
    ...
    while True:
        ...
        if position == -1:
            ...
            if html[position] == '(' or html[position] == ')' or html[position] == ',' or html[position] == '.' or html[
                position] == '!' or html[position] == '?' or html[position] == ':' or html[position] == '>' or html[
                position] == '<' or html[position] == ';' or html[position] == '"' or html[position] == '“':
                break
...
def getWordsAfter(end, html, word, number):
    ...
    while True:
        if position == len(html):
            ...
            if html[position] == '(' or html[position] == ')' or html[position] == ',' or html[position] == '.' or html[
                position] == '!' or html[position] == '?' or html[position] == ':' or html[position] == '>' or html[
                position] == ';' or html[position] == '"' or html[position] == '“':
                break
            if html[position] == '<':
...
def find_faculties():
    ...
    for id in ids:
        ...
        html = current_doc.get('_source').get('content')
        ...
        if current_term.get('term_vectors').get('content').get('terms').get('faculty') != None:
            fakul_eng = current_term.get('term_vectors').get('content').get('terms').get('faculty').get('tokens')
        ...
        for i in range(len(fakul)):
            ...
            while current_char != ">" and current_char_counter > -1 and current_char_counter < len(html):
